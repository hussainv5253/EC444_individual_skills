...
void getAccel(float * xp, float *yp, float *zp) {
  ...
  *xp = x * ADXL343_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD;
  *yp = y * ADXL343_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD;
  *zp = z * ADXL343_MG2G_MULTIPLIER * SENSORS_GRAVITY_STANDARD;
